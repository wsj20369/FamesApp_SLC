/***********************************************************************************************
 * 文件:    slc/plc_defs/jy524ce2.h
 *
 * 说明:    PLC暂存器定义(JY524CE2)
 *
 * 作者:    Jun
 *
 * 时间:    2011-4-9 ~ 2011-4-21 ~ 2012-10-16
***********************************************************************************************/
#ifdef THIS_IS_PLC_DEF_FILE
...
char   PLC_ADDR_SPEED[]       = "R00386";  /* 当前车速              */
...
PLC_MAP_LINK(id_read_speed,     PLC_ADDR_SPEED,         __slc_speed,        1,  FATEK_PLC_READ_R,   50, ___finish, 1)
...
#endif /* #ifdef THIS_IS_PLC_DEF_FILE */

/*==============================================================================================
 * 
 * 本文件结束: slc/plc_defs/jy524ce2.h
 * 
**============================================================================================*/
