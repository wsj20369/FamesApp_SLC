 ...
 * 
**---------------------------------------------------------------------------------------*/
gui_widget *   register_dialog = NULL;     /* 主控件 */
...
extern gui_widget  * main_screen; /* 主画面控件 */
...
void check_register_dialog(int x, int y, int need_quit)
{
    ...
    gui_show_widget(register_dialog);
    ...
    gui_hide_widget(register_dialog);
}
