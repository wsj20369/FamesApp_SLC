...
INPUT_DIALOG_ITEM("工号:", ORD_EDIT_WKNO,  4,  40,  38,  196, 28, 1, 0, "")
INPUT_DIALOG_ITEM("单号:", ORD_EDIT_ORDNO, 8,  256, 38,  196, 28, 1, 0, "")
INPUT_DIALOG_ITEM("剖数:", ORD_EDIT_CUTS,  2,  40,  72,  196, 28, 1, 0, "")
INPUT_DIALOG_ITEM("压线:", ORD_EDIT_DATA,  64, 40,  106, 628, 28, 1, 0, "")
INPUT_DIALOG_ITEM("压型:", ORD_EDIT_YX,    1,  256, 72,  196, 28, 1, 0, "")
INPUT_DIALOG_ITEM("楞别:", ORD_EDIT_FLUTE, 3,  472, 38,  196, 28, 1, 0, "")
INPUT_DIALOG_ITEM("修边:", ORD_EDIT_TIRM,  1,  472, 72,  196, 28, 1, 0, "")
INPUT_DIALOG_SET(edit_order_dialog, "订单编辑", &icon, 140, 418, 738, 221, 0, 236, 1, FORM_STYLE_XP_BORDER|FORM_STYLE_TITLE)
...
INPUT_DIALOG_SET(edit_order_dialog, "输单", &icon, 140, 418, 738, 221, 0, 236, 1, FORM_STYLE_XP_BORDER|FORM_STYLE_TITLE)
DECLARE_INPUT_DIALOG_ENDED(edit_order_dialog);
#endif
